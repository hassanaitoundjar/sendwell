<div class="sidebar ">
    <nav class="navbar  navbar-dark">
        <a href="index.html" class="navbar-brand mx-4 mb-3">
            <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i> <span class="hide-on-mobile">DarkPan</span>
            </h3>
        </a>
        ...
        <ul>
            ...
            <li>
                <a href="index.html"><i class="bi bi-journal-text me-2 fa-fw"></i>
            ...
            <li>
                <a href="index.html"><i class="bi bi-box-arrow-left me-2 fa-fw"></i>
                    <span class="hide-on-mobile">Logout</span></a>
            </li>

            <li>
                <i id="toggleButton" class="close fa fa-tachometer-alt me-2 fa-fw me-2 fa-fw"></i>
            </li>
